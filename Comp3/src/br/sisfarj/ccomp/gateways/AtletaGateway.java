...
public class AtletaGateway {
	public int inserir(String numero, String oficio, String nome, String nascimento, String entrada,
		...
		int matriculaGerada = bdConnection.execute(new UpdatingQuery("INSERT INTO comp3.atleta (numeroOficio, dataOficio, nome, dataNascimento, matriculaAssociacao, numeroPagamento, dataEntrada) "
				+ "VALUES ('" + numero + "', '" + t1 + "', '" + nome + "', '"
						+ t2 + "', " +  associacao + ", '" + comprovante + ", " + t3 + "')"), "MATRICULAASSOCIACAO");
